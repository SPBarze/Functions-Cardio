...
function subtractTwowNumbers(x,y) {
  let total = x - y;
  console.log(total);
  return total;
};

subtractTwowNumbers(7,9);
...
const greeting = `Greetings, ${firstName}!`;
...
function multipliedTwoNumbers(x,y) {
  let total = x*y
  console.log(total);
...
// dimensions
console.log(`The dimensions of the box are ${volume(2, 3, 5)} cubic meterss.`)
